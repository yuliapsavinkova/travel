...
export const post: BlogPost = {
  id: '11',
  slug: 'hidden-perks-of-house-sitting-nobody-talks-about',
  title: 'Hidden Perks of House Sitting Nobody Talks About (Real Examples)',
  ...
  seoDescription:
    'Discover the unexpected benefits of house sitting that nobody mentions: zero utilities, stocked pantries, entertainment subscriptions, and more.',
  seoKeywords: [
  ...
  body: (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>Surprises happen.</strong> I guarantee that almost every sit will include some
          kind of unexpected perk or pleasant discovery.
        </li>
      </ul>
