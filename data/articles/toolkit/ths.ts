export const thsContent = `
  ...
  <p>The platform is built on trust and reviews, which makes it easier to choose the right sit. I always read reviews carefully before committing to a stay, and that step is important for making sure it is a good fit for everyone involved.</p>
