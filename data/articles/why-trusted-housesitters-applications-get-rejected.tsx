...
export const content = (
  <>
    <p className="prose-lead">
      It is frustrating to be rejected and it happens more often than you think even to experienced
      sitters. You should never take it personally because most of the time it has nothing to do
      with you. I will tell you the top reasons why applications get rejected:
    </p>
    ...
    <ul>
      ...
      <li>
        <strong>Application Specifics:</strong> If your initial message is a template and doesn't
