  ...
  body: (
    <>
      <p className="prose-lead">
        I remember trying to get my very first house sit and feeling like it was impossible. Now
        that I've done sits all over the country, I can see that the first one is definitely the
        hardest hurdle.
      </p>
      ...
      <p>
        ...
        California right away. I had to find a way to show I was trustworthy without having a list
        of stars on my profile yet.
      </p>

      <h2>The Austin Story</h2>
      <p>
        One of the first sits I landed was in Austin, Texas, right in the middle of the summer. It
        was 105 degrees every single day and most people were trying to leave the city, not go to
        it. Because competition was low, the homeowners were willing to take a chance on someone new
        like me. I just wanted that first five-star review, so I was happy to be there even in the
        heat.
      </p>
      ...
      <ul>
        <li>
          <strong>I looked for short stays:</strong> People are usually less worried about a 2-day
          cat sit than a month-long stay with three dogs. Short sits are a great way to build up
          your profile fast.
        </li>
        <li>
          <strong>I was honest about being new:</strong> I didn't try to hide that this was my first
          time. I told them I worked from home and would be with their pets all day, which helped
          them feel better.
        </li>
        <li>
      ...
      <div className="prose-end">
        ...
        whole world opens up. I hope these simple things I found out help you land your first sit
        too.
        <br />
        <br />
