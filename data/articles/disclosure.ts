export const disclosureContent = `
  ...
  <p>I completed dozens of house sits across the United States before I ever shared a single link. My reputation as a professional steward is my most valuable asset. I will <strong>never</strong> recommend a tool, resource, or membership that I don't personally use and trust, regardless of the referral benefit.</p>

  <div class="prose-accent-box">
    <h3>Current Resource Partners</h3>
    <ul>
      <li><strong>TrustedHousesitters:</strong> Resource (Free Membership Months)</li>
      <li><strong>Rover:</strong> Resource (Pet Care Credits)</li>
      <li><strong>Visible:</strong> Resource (Mobile Service Credits)</li>
      <li><strong>Planet Fitness:</strong> Resource (Wellness Credits)</li>
    </ul>
  </div>

  <p>Thank you for using my links—it is a simple, no-cost way to support the free guides and blog entries I share here.</p>
`;
