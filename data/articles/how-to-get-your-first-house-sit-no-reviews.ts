...
export const content = `
  <p class="prose-lead">Your first house sit is the hardest one to get. After that, it gets 
  exponentially easier. The reason most people never get past this stage isn’t lack of 
  qualifications — it’s bad strategy.</p>

  <p>I got my first house sit with zero reviews by stacking the odds in my favor instead of 
  competing where everyone else applies. Here’s exactly how I did it, step by step.</p>
  ...
  <p>Then they panic when no one responds. That’s not a you problem. That’s a competition 
  problem. Homeowners don’t want to take risks when they have options. Your job for the 
  first sit is to remove risk and reduce competition.</p>

  <h2>Step 1: Choose a high-demand, low-competition location</h2>
  <p>I intentionally chose Austin, Texas for my first sit. Not because it’s glamorous — but 
  because it’s strategic. I applied during peak summer, when temperatures are brutal and 
  many sitters avoid the area.</p>
  
  <p>At the same time, Austin has a large and highly mobile tech community, which means 
  people travel frequently, often on short notice, even during off-season months. Fewer 
  sitters + plenty of homeowners = opportunity.</p>
  ...
  <p>For your first sit, cats are easier than dogs and short stays are easier than long 
  ones. Cats represent lower perceived responsibility, no rigid walking schedules, and 
  homeowners generally feel more flexible.</p>

  <p>I specifically applied to cat sits only and short trips (2–5 days). Short sits are 
  less commitment and lower risk—the ideal “yes” for a homeowner choosing someone 
  without reviews.</p>

  <div class="prose-image-block">
    <img src="https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?auto=format&fit=crop&q=80&w=1200" 
      alt="Cat in a sunlit home" />
    <span class="prose-caption">My first sit was 2 days and 2 cats for a homeowner 
  ...
  <blockquote class="prose-quote variant-plain">
    ...
    routines, litter care, and respecting their space. Since your trip is short, I’m 
    happy to do a quick video call beforehand if that helps you feel comfortable. I know 
    leaving pets can be stressful, and I’m happy to answer any questions. Best, Yulia"
  </blockquote>

  <p>This works because it's calm, specific, addresses their situation, and reduces 
  perceived risk without overselling.</p>

  <h2>Step 5: Expect rejection — it’s normal and meaningless</h2>
  <p>Even with a solid application, you will get declined or ignored. Reasons include: 
  ...
  and longer sits became realistic. House sitting has a clear snowball effect. The 
  ...
  <p>If you want your first house sit faster: apply off-season, avoid over-saturated 
  destinations, choose cats over dogs, and write calm, specific messages. Be selective, 
  not desperate. This isn’t luck — it’s strategy.</p>
