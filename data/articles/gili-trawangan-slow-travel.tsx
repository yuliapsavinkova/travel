...
export const content = (
  <>
    ...
    <div className="prose-accent-box">
      <h3>Where to stay</h3>
      <p>
        I found that Booking.com offered the most reliable selection of clean, modern hotels at
        great prices during the off-season. You can explore my recommended stays on their platform
        to find the best local gems.
      </p>
    </div>

    <h2>Life on Trawangan</h2>
    <p>
      The island is small enough to walk around entirely in about two hours. Beaches stretch around
      the whole perimeter, so you are always close to the water. While Trawangan is known for its
      nightlife, it is easy to find quiet spots if you look for them.
    </p>

    <h2>Learning to Dive</h2>
    <p>
      I didn't plan on getting scuba certified when I arrived. However, my hotel had a training pool
      right in front where I watched groups of divers every morning over breakfast. Eventually, it
      felt like the natural thing to do. The dive centers on the island are professional and the
      water is incredibly clear, making it a perfect place to learn.
    </p>
    ...
    <p>
      Gili Trawangan reset my pace. Learning to dive there was a spontaneous decision that became a
      highlight of my time in Indonesia, simply because the environment allowed for that kind of
      slow, intentional focus.
    </p>
  </>
);
