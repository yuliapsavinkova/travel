...
export const post: BlogPost = {
  ...
  seoDescription:
    'Master the race for high-demand listings on TrustedHousesitters using AI to apply faster and better while maintaining a human connection.',
  seoKeywords: [
    ...
    'winning the ths race',
    'ai for house sitting',
    'speed application ths',
    'how to get sits in major cities',
  ],
  body: (
    <>
      <p className="prose-lead">
        Highly competitive sits can fill their available application slots in under an hour. If
        you're carefully reading every detail before typing your first word, you've already lost to
        someone with a more efficient system.
      </p>
      ...
      <div className="prose-accent-box">
        ...
        <p>
          ...
          <strong>after</strong> you've secured your spot in the queue. If you discover a
          deal-breaker upon closer inspection, you can always send a polite follow-up or withdraw.
          But if you wait until you've read every word, the door will likely be closed.
        </p>
      </div>

      <h2>Step 4: The Unique Human Anchor</h2>
      <p>
        This is the most critical part of your template. It is a single, high-trust sentence that
        you write yourself once and keep for every application.
      </p>
      <p>
        Instead of a generic postscript, place this sentence directly in the body of your message.
        It should be something so specific to your lifestyle, career, or travel philosophy that it
      ...
      <p>
        ...
        traveler who leaves no trace? A remote professional who requires a stable home environment?
        A former homeowner who understands maintenance? Integrating this "Anchor" is what prevents
        your efficiency from feeling robotic.
      </p>
