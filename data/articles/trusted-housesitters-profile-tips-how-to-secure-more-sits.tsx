  ...
  body: (
    <>
      ...
      <p>
        ...
        like: you keep homes clean and organized, you follow feeding routines exactly, and you
        notice changes in pet behavior.
      </p>
      ...
      <p>
        ...
        straightforward language. Avoid walls of text. A clean, organized profile signals a clean
        and organized sitter.
      </p>

      <h2>7. Keep Your Profile Updated</h2>
      <p>
        An outdated profile looks abandoned. Update your bio when you complete new sits, add new
        photos of animals you've bonded with, and keep your availability calendar current. Even
        small updates signal that you are active and engaged.
      </p>
