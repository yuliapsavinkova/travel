...
export const privacyPolicyContent = `
  ...
  <p>I collect information you voluntarily provide through the <strong>Contact Inquiry Form</strong>, which includes your name, email address, and any message content. This data is used solely to respond to your inquiries and is never sold to third parties.</p>
  ...
  <h2>5. Your Rights</h2>
  <p>You have the right to request that I delete any personal information (such as your name and email from my inbox) that you have provided. To do so, please contact me directly at the email provided below.</p>

  <h2>6. Policy Updates</h2>
  <p>I may update this policy from time to time. Any changes will be posted on this page with an updated "Last Modified" date.</p>

  <div class="prose-accent-box">
    <h3>Contact</h3>
    <p>If you have questions regarding this policy, please reach out via the contact form or directly at <strong>sitterjourney@gmail.com</strong>.</p>
  </div>
`;
