...
import { MapPinIcon, CalendarIcon, StarIcon, QuoteIcon, ExternalLinkIcon } from '../../../components/Icons';
        ...
        sidebar={
          <div className="detail-content-section">
            <div className="flex-col flex-gap-md">
              ...
              <div className="detail-testimonial-attribution sub-header" style={{ marginBottom: 'var(--s-4)' }}>
                — {stay.name}
              </div>
