    ...
    <div className="container">
      <section className="hero-stack section-margin">
        <div className="media-viewport">
          <img src="https://images.unsplash.com/photo-1510798831971-661eb04b3739?auto=format&fit=crop&q=80&w=2400" alt="Estate Stewardship" />
          <div className="hero-gradient-overlay" />
        </div>

        <div className="hero-content-overlay">
          <div className="sub-header hero-sub-header">Verified Stewardship</div>
          <h1 className="display-title">Stewardship for <br/>Homes and <span className="champagne-text">Furry Friends.</span></h1>
          <p className="hero-paragraph">
            Providing high-end care and consistent companionship for elite properties and their beloved animal residents.
          </p>
          <div className="hero-button-group">
            <Link href="#portfolio" className="btn-gold">The Portfolio</Link>
      ...
      <header className="text-center section-margin" id="portfolio">
        ...
        <h2 className="display-title display-title-md">Verified <span className="serif-italic champagne-text">History.</span></h2>
      </header>
