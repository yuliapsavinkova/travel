      ...
      <section className="section-margin text-center">
        <div className="section-divider">
          ...
          <p className="hero-paragraph" style={{ margin: 'var(--s-4) auto' }}>
            My full-time travel is supported by a foundation of professional stewardship. If you are
            seeking a trusted traveler to care for your home while you are away, I’d love to
            connect.
          </p>
